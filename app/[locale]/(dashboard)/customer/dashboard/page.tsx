    ...
    return (
        <div className="px-4 lg:px-6 py-6">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-600">Track your orders and discover fresh products</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">On local products</p>
                    </CardContent>
                </Card>
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/customer/orders">
                            <span className="text-sm text-green-600 hover:underline">View all</span>
                        </Link>
                    </div>
                </CardHeader>
                <CardContent>
